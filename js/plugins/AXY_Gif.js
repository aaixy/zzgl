...
//=============================================================================
 /*:
 * @plugindesc v1.2 This plugin show gif, jpg, and many formats img from website or local.
...
AXY_Gif = {
	show: function () {
		...
		var tag 		=	 AXYGifArgs['tag'] ? AXYGifArgs['tag'] : ""; //img or html code
		...
		switch(tag){
			case 'gifv':
				var gifvcode = filename.replace('http://i.imgur.com/', '').replace('.gifv', '');
				console.log(gifvcode);
				var taghtml = '<div style="width:'+
		width+';height:'+
		height+';opacity:'+
		opacity+';" /><blockquote class="imgur-embed-pub" lang="en" data-id="'+
		gifvcode+'"><a href="'+
		filename+'">Prepare yourselves for the future</a></blockquote><script async src="http://s.imgur.com/min/embed.js" charset="utf-8"></script>';
				break;
			case 'img':
			default:
				var taghtml = '<img src="'+
		...
		AXY.Gif.Param.zIndex+';">'+taghtml+'</div>';
