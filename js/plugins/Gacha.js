...
//-----------------------------------------------------------------------------
// Window_Help_can_17520
//
// The window for displaying the description of the selected item.

function Window_Help_can_17520() {
    this.initialize.apply(this, arguments);
}

Window_Help_can_17520.prototype = Object.create(Window_Base.prototype);
Window_Help_can_17520.prototype.constructor = Window_Help_can_17520;

Window_Help_can_17520.prototype.initialize = function(numLines) {
...
Window_Help_can_17520.prototype.setText = function(text) {
    if (this._text !== text) {
        this._text = text;
        this.refresh();
    }
...
Window_Help_can_17520.prototype.clear = function() {
    this.setText('');
};

Window_Help_can_17520.prototype.setItem = function(item) {
    this.setText(item ? item.description : '');
};

Window_Help_can_17520.prototype.refresh = function() {
    this.contents.clear();
    ...
    Scene_Gacha.prototype.createHelpWindow = function() {
        this._helpWindow = new Window_Help_can_17520();
